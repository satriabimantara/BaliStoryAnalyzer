...
class LexiconFeatureExtraction(BaseModelFeatureExtraction):
    ...
    def __init__(self,
                 ...
                 lexicon_enrichment_files={
                     'negation_words': os.path.join(settings.BALINLP_BALISENTILEX, 'negation_words.txt'),
                     'booster_words': os.path.join(settings.BALINLP_BALISENTILEX, 'negation_words.txt')
                 },
                 tags_dictionary={
                     'noun': 'NN',
                     'adjective': 'JJ',
